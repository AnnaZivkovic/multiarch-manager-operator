...
require (
	...
	github.com/openshift/api v0.0.0-20260701125932-bfd28b0f0ba1
	github.com/openshift/library-go v0.0.0-20260701140838-bac4e5e3e72c
...
require (
	...
	github.com/docker/docker-credential-helpers v0.9.8 // indirect; indirectk8s.io/api
