...
//+kubebuilder:webhook:path=/mutate-multiarch-openshift-io-v1beta1-podplacementconfig,mutating=true,failurePolicy=fail,sideEffects=None,groups=multiarch.openshift.io,resources=podplacementconfigs,verbs=create;update,versions=v1beta1,name=mpodplacementconfig.kb.io,admissionReviewVersions=v1

var _ webhook.Defaulter = &PodPlacementConfig{}

// Default implements webhook.Defaulter so a webhook will be registered for the type
func (r *PodPlacementConfig) Default() {
	podplacementconfiglog.Info("default", "name", r.Name)
