...
const (
	...
	ArchitecturePreferredPredicateSetupMsg   = "Set the preferred nodeAffinity for the architecture to "
	ArchitecturePreferredPredicateSkippedMsg = "Not setting the preferred nodeAffinity. PreferredDuringSchedulingIgnoredDuringExecution " + utils.ArchLabel + " already set"
